            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              ...
              <div>
                <h3 className="text-3xl font-bold text-green-600">
                  {members.filter(member => member.hasBpjs).length}
                </h3>
                <p className="text-slate-600">Memiliki BPJS</p>
              </div>
              <div>
                <h3 className="text-3xl font-bold text-blue-600">
                  {members.filter(member => member.receivesSocialAssistance).length}
                </h3>
                <p className="text-slate-600">Menerima Bantuan Sosial</p>
              </div>
            </div>
          </div>
        </div>
